				...
				<div className="mt-4 space-y-4">
					...
					<div className="flex items-center justify-between px-1.5 py-2.5">
						<div className="flex items-center gap-2 min-w-0 flex-1">
							...
							<span className="text-sm md:text-base text-typo-primary truncate">{businessInfo.callCentreNumber}</span>
						</div>
					...
					<div className="flex items-center justify-between px-1.5 py-2.5">
						<div className="flex items-center gap-2 min-w-0 flex-1">
							...
							<span className="text-sm md:text-base text-typo-primary truncate">{businessInfo.callCentreEmailAddress}</span>
						</div>
						<div className="flex gap-5 flex-shrink-0 ml-2">
							<Button
								variant="ghost"
					...
					<div className="flex items-center justify-between px-1.5 py-2.5">
						<div className="flex items-center gap-2 min-w-0 flex-1">
							...
							<span className="text-sm md:text-base text-typo-primary w-[90%]">{businessInfo.companyAddress}</span>
						</div>
						<div className="flex gap-5 flex-shrink-0 ml-2">
							<Button
								variant="ghost"
