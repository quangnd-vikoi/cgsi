        ...
        <div>
            ...
            <div className="mt-6 space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        <Input
                            ...
                            disabled
                            className="bg-theme-neutral-095 text-sm md:text-base font-normal text-typo-tertiary pr-20"
                        />
                    </div>
                </div>
                    ...
                    <div className="relative">
                        <div className="absolute left-3 top-1/2 -translate-y-1/2 flex items-center gap-1">
                            <CircleFlag
                                ...
                                className="w-5 h-5"
                            />
                            <span className="text-sm md:text-base ml-2 font-normal text-typo-primary">
                                {dialCode}
                            </span>
                        </div>
                        <Input
                            ...
                            value={phoneNumber}
                            disabled
                            className="disabled:opacity-100 pl-20 pr-20 text-sm md:text-base font-normal text-typo-primary"
                        />
                        {updatePerms.sidebar_update_mobile && (
                            <Button
                                onClick={() => handleUpdateClick("mobile")}
                                variant="link"
                                className="!text-cgs-blue underline underline-offset-2 text-sm md:text-base font-medium absolute right-0 top-1/2 -translate-y-1/2 h-auto py-0 px-3"
                            >
                                Update
                            </Button>
                        )}
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        <Input
                            className="disabled:opacity-100 pr-20 text-sm md:text-base font-normal text-typo-primary"
                            id="email"
                            type="email"
                            value={displayEmail}
                            disabled
                ...
                {updatePerms.sidebar_update_signature && (
                    <div className="space-y-3">
                        <Label className="font-semibold text-typo-primary">
                            Signature
                        </Label>
                        <p className="text-sm font-normal text-typo-secondary leading-relaxed pr-1">
                            Updating your signature will replace the existing
                            one, or create a new record if none exists. The
                            signature will be stored securely but won&apos;t be
                        ...
                        <Button
                            ...
                            variant="outline"
                            className="w-full border-dashed border-cgs-blue bg-background-section justify-between py-3 !px-4 text-sm md:text-base font-medium text-cgs-blue h-fit hover:bg-cgs-blue/10 hover:text-cgs-blue"
                        >
                            Update Signature
