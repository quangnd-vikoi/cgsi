...
export const MobileInputStep = ({ phoneNumber, setPhoneNumber, error, setError, selectedCountry, setSelectedCountry }: MobileInputStepProps) => {
	...
	return (
		<div className="pad-x">
			<p className="text-base md:text-lg font-semibold mb-6">Enter new mobile number</p>
			<div className="flex w-full relative">
				<Dialog open={open} onOpenChange={setOpen}>
					<DialogTrigger className="absolute left-1">
						<div className="flex gap-2 items-center px-1 shrink-0 text-sm md:text-base font-normal text-typo-primary">
							<CircleFlag
				...
				<Input
					className="flex-1 pl-24 text-sm md:text-base font-normal text-typo-primary focus:bg-background-section focus:!border-b-cgs-blue"
