...
const UpdateSignature = () => {
    ...
    const [status, setStatus] = useState<"update" | "success" | "failed">(
        "update",
    );
    ...
    const handleSubmit = async () => {
        ...
        const uploadResponse = await uploadSignature(fileToUpload, "main");
                                ...
                                <div className="w-full mt-6">
                                    <div className="text-typo-secondary text-normal text-sm">
                                        <p>
                                            ...
                                            image, please ensure the following:
                                        </p>
                                        <ul className="list-disc list-outside mt-2 pl-4 md:pl-6 space-y-1">
                                            <li>
                                                The signature is signed on a
                                                blank white sheet of paper using
                                                a black or blue pen
                                            </li>
                                            <li>
                                                The signature is fully visible
                                                and unobstructed
                                            </li>
                                            <li>
                                                The image is clear and in high
                                                resolution
                                            </li>
                                        </ul>
                                        ...
                                        <div className="mt-6">
                                            ...
                                            to ensure your upload meets the
                                            required standards.
                                        </div>
