    ...
    return (
        <div className="bg-white rounded-lg flex-1 flex flex-col overflow-hidden min-h-0">
            ...
            <div className="border-t pad-x py-4 justify-end flex gap-2">
                <Alert
                    trigger={
                        <Button disabled={selectedItems.length === 0} variant="outline" onClick={handleRemoveAllItems} className="px-3 border-none text-enhanced-blue hover:text-enhanced-blue/75 shadow-none hover:bg-transparent disabled:text-status-disable-primary">
                            Remove All
                        </Button>
                    }
