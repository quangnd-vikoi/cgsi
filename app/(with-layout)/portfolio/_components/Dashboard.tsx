...
const Dashboard = ({ type: propType, onTypeChange }: DashboardProps) => {
    ...
    const accountType = selectedAccount?.accountType as
        | PortfolioType
        | undefined;
    const type = propType || accountType;
    const router = useRouter();
    const { isAllowed: showContractsContra, userType } = usePermission(
        FEATURE_ACCESS.portfolio_contracts_contra,
    );
    ...
    const [accountSummary, setAccountSummary] =
        React.useState<IAccountSummary | null>(null);
            ...
            },
            {
                ...
                component: (
                    <DashboardBlock
                        ...
                        showPayButton={
                            showContractsContra &&
                            !!accountSummary?.contractsBuy &&
                            accountSummary.contractsBuy !== 0
                        }
                        onPay={() =>
                            router.push(
            ...
            },
            {
                ...
                component: (
                    <DashboardBlock
                        ...
                        showPayButton={
                            showContractsContra &&
                            !!accountSummary?.contraLoss &&
                            accountSummary.contraLoss !== 0
                        }
                        onPay={() =>
            ...
            },
            {
                ...
                component: (
                    <DashboardBlock
                        ...
                        amount={formatCurrency(
                            accountSummary?.collateralValue,
                            "SGD",
                            "unsigned",
                        )}
                        type="normal"
        ...
        <div className="bg-white pad-x py-6 rounded border border-stroke-secondary">
            <div className="flex flex-col md:flex-row gap-4">
                <div className={cn("w-full", !isFullWidth && "md:w-1/2")}>
                    <TypeSelect
                        totalAsset={accountSummary?.totalAsset ?? 0}
