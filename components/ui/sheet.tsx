	...
	return (
		<SheetPortal>
			...
			<SheetPrimitive.Content
				...
				className={cn(
					"bg-background data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-[100] md:z-[102] flex flex-col gap-4 shadow-lg data-[state=closed]:duration-200 data-[state=open]:duration-300 pointer-events-auto",
					side === "right" &&
